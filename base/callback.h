...
inline typename
_ConstMemberResultCallback_0_1<true, R, T1, A1>::base*
NewCallback(
...
template <class T1, class T2, class R, class A1>
inline typename
_ConstMemberResultCallback_0_1<false, R, T1, A1>::base*
NewPermanentCallback(
    const T1* obj, R (T2::*member)(A1) const) {
...
class _ConstMemberResultCallback_0_2 :
  public ResultCallback2<R, A1, A2> {
 public:
...
inline typename
_ConstMemberResultCallback_0_2<true, R, T1, A1, A2>::base*
NewCallback(
...
template <class T1, class T2, class R, class A1, class A2>
inline typename
_ConstMemberResultCallback_0_2<false, R, T1, A1, A2>::base*
NewPermanentCallback(
    const T1* obj, R (T2::*member)(A1, A2) const) {
...
template <class T1, class T2, class R, class A1, class A2>
inline typename
_MemberResultCallback_0_2<true, R, T1, A1, A2>::base*
NewCallback(
...
template <class T1, class T2, class R, class A1, class A2>
inline typename
_MemberResultCallback_0_2<false, R, T1, A1, A2>::base*
NewPermanentCallback(
    T1* obj, R (T2::*member)(A1, A2) ) {
...
class _FunctionResultCallback_0_2 :
  public ResultCallback2<R, A1, A2> {
 public:
  typedef ResultCallback2<R, A1, A2> base;
...
NewCallback(R (*function)(A1, A2)) {
  return
      new _FunctionResultCallback_0_2<true, R, A1, A2>(function);
}

template <class R, class A1, class A2>
inline typename
_FunctionResultCallback_0_2<false, R, A1, A2>::base*
NewPermanentCallback(R (*function)(A1, A2)) {
  return
      new _FunctionResultCallback_0_2<false, R, A1, A2>(function);
}
...
class _ConstMemberResultCallback_0_3 :
  public ResultCallback3<R, A1, A2, A3> {
 public:
...
inline typename
_ConstMemberResultCallback_0_3<true, R, T1, A1, A2, A3>::base*
NewCallback(
    const T1* obj, R (T2::*member)(A1, A2, A3) const) {
  return new
      _ConstMemberResultCallback_0_3<true, R, T1, A1, A2, A3>(obj,
          member);
}
#endif
...
template <class T1, class T2, class R, class A1, class A2, class A3>
inline typename
_ConstMemberResultCallback_0_3<false, R, T1, A1, A2, A3>::base*
NewPermanentCallback(
    const T1* obj, R (T2::*member)(A1, A2, A3) const) {
  return new
      _ConstMemberResultCallback_0_3<false, R, T1, A1, A2, A3>(
      obj, member);
}
#endif
...
template <class T1, class T2, class R, class A1, class A2, class A3>
inline typename
_MemberResultCallback_0_3<true, R, T1, A1, A2, A3>::base*
NewCallback(
...
template <class T1, class T2, class R, class A1, class A2, class A3>
inline typename
_MemberResultCallback_0_3<false, R, T1, A1, A2, A3>::base*
NewPermanentCallback(
    T1* obj, R (T2::*member)(A1, A2, A3) ) {
...
class _FunctionResultCallback_0_3 :
  public ResultCallback3<R, A1, A2, A3> {
 public:
  typedef ResultCallback3<R, A1, A2, A3> base;
...
template <class R, class A1, class A2, class A3>
inline typename
_FunctionResultCallback_0_3<true, R, A1, A2, A3>::base*
NewCallback(R (*function)(A1, A2, A3)) {
  return new
      _FunctionResultCallback_0_3<true, R, A1, A2, A3>(function);
}

template <class R, class A1, class A2, class A3>
inline typename
_FunctionResultCallback_0_3<false, R, A1, A2, A3>::base*
NewPermanentCallback(R (*function)(A1, A2, A3)) {
  return new
      _FunctionResultCallback_0_3<false, R, A1, A2, A3>(function);
}
...
class _ConstMemberResultCallback_1_1 :
 ...
 public:
  inline _ConstMemberResultCallback_1_1(
      const T* object, MemberSignature member, P1 p1)
  ...
  virtual void CheckIsRepeatable() const {
    if (del)
      CallbackUtils_::FailIsRepeatable("ResultCallback1<R, A1>");
  }
...
public Callback1<A1> {
 ...
 public:
  inline _ConstMemberResultCallback_1_1(const T* object,
...
inline typename
_ConstMemberResultCallback_1_1<true, R, T1, P1, A1>::base*
NewCallback(const T1* obj, R (T2::*member)(P1, A1) const, P1 p1) {
  return new
      _ConstMemberResultCallback_1_1<true, R, T1, P1, A1>(obj,
                                              member, p1);
}
#endif
...
template <class T1, class T2, class R, class P1, class A1>
inline typename
_ConstMemberResultCallback_1_1<false, R, T1, P1, A1>::base*
NewPermanentCallback(const T1* obj,
    R (T2::*member)(P1, A1) const, P1 p1) {
  return new
      _ConstMemberResultCallback_1_1<false, R, T1, P1, A1>(obj,
          member, p1);
}
#endif
...
class _MemberResultCallback_1_1 : public ResultCallback1<R, A1> {
 ...
 public:
  inline _MemberResultCallback_1_1(T* object,
      MemberSignature member, P1 p1)
      : ResultCallback1<R, A1>(),
        object_(object),
        member_(member),      p1_(p1) { }
...
NewCallback(T1* obj, R (T2::*member)(P1, A1) , P1 p1) {
  return new
      _MemberResultCallback_1_1<true, R, T1, P1, A1>(obj,
          member, p1);
}
#endif
...
template <class T1, class T2, class R, class P1, class A1>
inline typename
_MemberResultCallback_1_1<false, R, T1, P1, A1>::base*
NewPermanentCallback(T1* obj, R (T2::*member)(P1, A1) , P1 p1) {
  return new
      _MemberResultCallback_1_1<false, R, T1, P1, A1>(obj,
          member, p1);
}
#endif
...
class _FunctionResultCallback_1_1<del, void, P1, A1> :
public Callback1<A1> {
 public:
  typedef Callback1<A1> base;
...
NewCallback(R (*function)(P1, A1), P1 p1) {
  return new
      _FunctionResultCallback_1_1<true, R, P1, A1>(function, p1);
}
...
NewPermanentCallback(R (*function)(P1, A1), P1 p1) {
  return new
      _FunctionResultCallback_1_1<false, R, P1, A1>(function, p1);
}
...
class _ConstMemberResultCallback_1_2 :
 ...
 public:
  inline _ConstMemberResultCallback_1_2(const T* object,
                              MemberSignature member, P1 p1)
  ...
  virtual void CheckIsRepeatable() const {
    if (del)
      CallbackUtils_::FailIsRepeatable("ResultCallback2<R, A1, A2>");
  }
...
inline typename
_ConstMemberResultCallback_1_2<true, R, T1, P1, A1, A2>::base*
NewCallback(const T1* obj, R (T2::*member)(P1, A1, A2) const, P1 p1) {
  return new
      _ConstMemberResultCallback_1_2<true, R, T1, P1, A1, A2>(obj,
                                              member, p1);
}
#endif
...
template <class T1, class T2, class R, class P1, class A1, class A2>
inline typename
_ConstMemberResultCallback_1_2<false, R, T1, P1, A1, A2>::base*
NewPermanentCallback(const T1* obj,
                    R (T2::*member)(P1, A1, A2) const, P1 p1) {
  return new
      _ConstMemberResultCallback_1_2<false, R, T1, P1, A1, A2>(obj,
                                              member, p1);
}
#endif
...
class _MemberResultCallback_1_2 :
 ...
 public:
  inline _MemberResultCallback_1_2(T* object,
                                  MemberSignature member, P1 p1)
      : ResultCallback2<R, A1, A2>(),
        object_(object),
        member_(member),      p1_(p1) { }
...
template <class T1, class T2, class R, class P1, class A1, class A2>
inline typename
_MemberResultCallback_1_2<true, R, T1, P1, A1, A2>::base*
NewCallback(T1* obj, R (T2::*member)(P1, A1, A2) , P1 p1) {
  return new
      _MemberResultCallback_1_2<true, R, T1, P1, A1, A2>(obj,
          member, p1);
}
#endif
...
template <class T1, class T2, class R, class P1, class A1, class A2>
inline typename
_MemberResultCallback_1_2<false, R, T1, P1, A1, A2>::base*
NewPermanentCallback(T1* obj, R (T2::*member)(P1, A1, A2) , P1 p1) {
  return new
      _MemberResultCallback_1_2<false, R, T1, P1, A1, A2>(obj,
          member, p1);
}
#endif

template <bool del, class R, class P1, class A1, class A2>
class _FunctionResultCallback_1_2 :
  public ResultCallback2<R, A1, A2> {
 public:
  typedef ResultCallback2<R, A1, A2> base;
...
inline typename
_FunctionResultCallback_1_2<true, R, P1, A1, A2>::base*
NewCallback(R (*function)(P1, A1, A2), P1 p1) {
  return
      new _FunctionResultCallback_1_2<true, R, P1, A1, A2>(function,
          p1);
}

template <class R, class P1, class A1, class A2>
inline typename
_FunctionResultCallback_1_2<false, R, P1, A1, A2>::base*
NewPermanentCallback(R (*function)(P1, A1, A2), P1 p1) {
  return new
      _FunctionResultCallback_1_2<false, R, P1, A1, A2>(function, p1);
}
