...
const uint32 kuint24max = ((uint32) 0xFFFFFF);
...
// A macro to declare constructor and destructor into private block.
// To make all member a static.
...
const uint64 kKBytes = 1024;
const uint64 kMBytes = 1024 * kKBytes;
